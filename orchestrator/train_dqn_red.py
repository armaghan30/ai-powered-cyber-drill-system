...
def main():
    ...
    model_path = f"results/models/custom_dqn_red_{topo}.pth"
    csv_path = f"results/csv/custom_dqn_red_{topo}.csv"

    agent.save(model_path)
    print(f"[RED] Model saved -> {model_path}")
    ...
    print(f"[RED] Episode rewards saved -> {csv_path}")
